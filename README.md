Copia y pega este bloque único en tu terminal de Ubuntu (WSL2). El script crea la carpeta del proyecto, genera `requirements.txt`, `.gitignore`, `README.md` (sin referencias al Tec) y todos los scripts de Python con la indentación correcta; posteriormente inicializa el entorno virtual `rl_env`, instala las dependencias e inicializa el repositorio Git:
